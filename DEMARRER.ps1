...
if (-not (Test-Path $app)) {
    Write-Host " ERREUR : dossier 'lumenjuris' introuvable a : $app" -ForegroundColor Red
    Write-Host " Verifiez que DEMARRER.bat est bien dans le dossier parent de 'lumenjuris'." -ForegroundColor Red
