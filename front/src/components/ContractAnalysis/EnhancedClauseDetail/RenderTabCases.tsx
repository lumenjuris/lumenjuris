        ...
        {isLoadingDecisions ? (
          <div className="space-y-3">
            {Array.from({ length: 3 }).map((_, i) => (
              <div
                key={i}
                className="p-3 border rounded-md bg-slate-50 animate-pulse space-y-2"
              >
              ...
              return (
                ...
                >
                  ...
                  {decision.litige || decision.resultat ? (
                    ...
                    <p className="text-xs text-slate-600 line-clamp-4 pt-1 border-t border-slate-200">
                      {decision.summary}
                    </p>
                  ) : null}
                </div>
          ...
          <div className="text-center text-slate-500 p-6 border-dashed border-2 rounded-lg">
            ...
            <p className="text-sm text-slate-400 mt-1">
              Pas de résultats avec la recherche automatique.
            </p>
          </div>
        )}
      </section>
