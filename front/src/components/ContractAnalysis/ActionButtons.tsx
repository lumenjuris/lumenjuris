...
export const ActionButtons: React.FC<ActionButtonsProps> = ({
  ...
  const btnPrimary = "inline-flex items-center gap-2 px-4 py-2 text-xs font-semibold text-slate-900 bg-white hover:bg-slate-100 hover:-translate-y-0.5 rounded-xl shadow-sm transition-all disabled:opacity-50 shrink-0";
  const btnGhost = "inline-flex items-center gap-2 px-3.5 py-2 text-xs font-medium text-slate-200 bg-white/10 hover:bg-white/20 border border-white/10 hover:-translate-y-0.5 rounded-xl backdrop-blur-sm transition-all disabled:opacity-50 shrink-0";
