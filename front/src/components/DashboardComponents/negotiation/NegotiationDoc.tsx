      ...
      <div className="lg:col-span-3 bg-white rounded-card border border-line shadow-card">
        ...
        {text || editable ? (
          <div
            ...
            className={`text-sm text-ink-secondary whitespace-pre-wrap break-words leading-relaxed font-sans selection:bg-brand/20 p-4 sm:p-5 outline-none ${editable ? "min-h-[40vh] focus:bg-surface-subtle/40 empty:before:content-[attr(data-placeholder)] empty:before:text-ink-placeholder" : ""}`}
          >
            {segments.map((seg, i) =>
              seg.ann ? (
                <mark
