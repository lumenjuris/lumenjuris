...
const kpiCards = [
  {
    icon: FileText,
    iconBg: "bg-slate-100 text-black-500",
    value: "48",
...
const veilleItems = [
  {
    ...
    title: "Nouvelle obligation d'information des salariés en CDD",
    date: "28 fév. 2026",
  },
  {
    tag: "Rupture",
    tagClass: "bg-orange-100 text-orange-700",
    title: "Réforme des indemnités prud'homales : barème actualisé",
    date: "25 fév. 2026",
  },
  {
    tag: "Discipline",
    tagClass: "bg-purple-100 text-purple-700",
    title: "Procédure disciplinaire : nouveaux délais de prescription",
    date: "22 fév. 2026",
  },
];
...
const docTypes = [
  ...
  {
    icon: BookOpen,
    label: "Lettre disciplinaire",
    sub: "Procédure disciplinaire",
  },
];
    ...
    <div className="space-y-6 max-w-7xl">
      <div className="flex items-end justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Vue d'ensemble de votre conformité RH
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-gray-400 mt-0.5">
                Vérifiez la conformité de vos documents
              </p>
            </div>
          ...
          <Link
            to="/conformite"
            className="inline-flex items-center gap-2 text-sm font-medium text-lumenjuris hover:text-lumenjuris transition-colors"
          >
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-gray-400 mt-0.5">
                Créez des documents juridiques conformes
              </p>
            </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-gray-400 mt-0.5">
                Réponses avec sources juridiques
              </p>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm text-gray-800">
                  "Quelles sont les obligations lors d'un licenciement pour
                  faute grave ?"
                </p>
                <p className="text-xs text-gray-400 mt-1.5">
                  Sources : Art. L1232-1, L1234-1 du Code du travail
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-gray-400 mt-0.5">
                Estimations légales instantanées
              </p>
            </div>
            ...
            <div className="space-y-2.5">
              {[
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-800 bg-white px-2.5 py-1 rounded-md border border-gray-200">
                    {row.value}
                  </span>
                </div>
              ))}
          ...
          {veilleItems.map((item, i) => (
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <span
                  className={`text-xs font-medium px-2 py-0.5 rounded-full ${item.tagClass}`}
                >
                  {item.tag}
                </span>
              </div>
              <p className="text-sm font-medium text-gray-800 leading-snug group-hover:text-lumenjuris transition-colors">
                {item.title}
              </p>
